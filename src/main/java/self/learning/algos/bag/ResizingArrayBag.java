...
public class ResizingArrayBag<Item> implements Iterable<Item> {
     ...
     * <br>
     * When the capacity is full, it will be resized to double its initial
     * capacity
     *
    ...
    /**
     * Returns an iterator that iterates over the items in the bag, arbitrary
     * order
     *
     * @return an iterator that iterates over the items in the bag, arbitrary
     * order
     */
    @Override
